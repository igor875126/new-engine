...
export default class Listeners {
     ...
     * Constructor
     */
    constructor(input: Input, canvas: HTMLCanvasElement, renderer: Renderer, gameObjectsManager: GameObjectsManager, environment: 'development' | 'production', camera: Camera, scalingManager: ScalingManager) {
        this.input = input;
        this.canvas = canvas;
     ...
     * TODO integrate scale manager? Need to test it on mobile
     */
