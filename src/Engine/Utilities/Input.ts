...
/**
 * The Input class is a fundamental component in game development and user interaction handling.
 * It is designed to capture and manage various types of input, including mouse, keyboard, and touch events,
 * providing an interface for retrieving the status and information related to these inputs.
 */
