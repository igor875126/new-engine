/**
 * The Color class is designed to represent and manipulate colors.
 * It provides methods for converting colors between different formats (such as RGB and hex)
 * and for setting and retrieving color components.
 */
